...
后续 24 Worker 并行方案已经冻结：12 Worker 跑 EXP-14 的 K64 双种子
CE/Query/no-query/anti-copy 机制诊断，4 Worker 跑 raw/A4 的 2fps official-budget
MVBench anchor，7 Worker 可继续现有 matched-32 anchor，保留 1 Worker。完整拉取、提交、
checkpoint 续训、自动释放与判读方法见
[`docs/EXP13_EXP14_PARALLEL_RUNBOOK.md`](docs/EXP13_EXP14_PARALLEL_RUNBOOK.md)。
